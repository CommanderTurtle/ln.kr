...
function usage (exitCode = 0) {
  console.error(`Usage:
  lnkr encode <text|-> [ascii|emoji|qr] [auto|text|markdown|javascript|html] [v1|v2|v3|v4]
...
if (command === "encode") {
  ...
  if (!alphabet || !["v1", "v2", "v3", "v4"].includes(version)) usage(2);
  const input = inputArgument === "-" ? readFileSync(0, "utf8") : inputArgument;
  const encoder = version === "v4"
    ? compressTextV4
    : version === "v3"
      ? compressTextV3
